...
const ServiceCard = ({ name, icon, color }) => (
  <div className={`${color} group p-8 rounded-[40px] shadow-xl shadow-blue-100 flex flex-col items-center gap-4 cursor-pointer hover:-translate-y-2 transition-all duration-300 relative overflow-hidden`}>
